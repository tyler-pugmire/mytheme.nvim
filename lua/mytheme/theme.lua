...
theme.set_highlights = function(opts)
    ...
    -- NvimTree
    hl(0, 'NvimTreeRootFolder', { fg = my_c.Keyword, bg = 'NONE', bold = true })
    ...
    hl(0, 'NvimTreeFolderName', { fg = my_c.Foreground, bg = 'NONE' })
    hl(0, 'NvimTreeSpecialFile', { fg = c.vscPink, bg = 'NONE', underline = true })
    hl(0, 'NvimTreeNormal', { fg = my_c.Foreground, bg = 'NONE' })
    hl(0, 'NvimTreeCursorLine', { fg = 'NONE', bg = opts.disable_nvimtree_bg and c.vscCursorDarkDark or c.vscLeftMid })
    hl(0, 'NvimTreeVertSplit', { fg = opts.disable_nvimtree_bg and c.vscSplitDark or my_c.Background, bg = "NONE" })
